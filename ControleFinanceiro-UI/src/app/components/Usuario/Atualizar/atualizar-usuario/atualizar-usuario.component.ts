  ...
  ngOnInit(): void {
    ...
    this.usuariosService.PegarUsuarioPeloId(this.usuarioId).subscribe((resultado) =>{
      ...
      this.formulario = new FormGroup({
        ...
        username: new FormControl(resultado.userName, [Validators.required, Validators.minLength(6), Validators.maxLength(50)]),
        ...
        profissao: new FormControl(resultado.profissao, [Validators.required, Validators.minLength(1), Validators.maxLength(30)]),
        ...
        (resultado) => {
          ...
          this.usuariosService.AtualizarUsuario(atualizarUsuario).subscribe(
            (resposta) => {
              ...
              this.snackBar.open(resposta.mensagem, '', {
                duration: 2000,
