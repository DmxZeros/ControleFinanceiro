...
namespace ControleFinanceiro.API.Controllers
{
    ...
    public class DashboardController : ControllerBase
    {
        ...
        {
            int qtdCartoes = await _cartaoRepositorio.PegarQuantidadCartoesPeloUsuarioId(usuarioId);
        ...
        public object PegarDadosAnuaisPeloUsuarioId(string usuarioId, int ano)
        {
            return (new
            {
                ganhos = _graficoRepositorio.PegarDesepesasAnuaisPeloUsuarioId(usuarioId, ano),
                despesa = _graficoRepositorio.PegarGanhosAnuaisPeloUsuarioId(usuarioId, ano),
